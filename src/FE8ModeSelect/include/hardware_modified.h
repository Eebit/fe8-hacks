...
// This is just the decomp's "hardware.h" (as of 2023-10-24) with a
// single modification to the LCDControlBuffer struct to use a sub-struct for BG2 manipulation at +0x48
